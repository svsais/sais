...
echo "# Autogenerated Variable Transfer" > /mnt/sais.sh
vtrans () {
	echo $1 >> /mnt/sais.sh
}
...
curl "https://svsais.github.io/sais/chr.sh" >> /mnt/sais.sh
sdone
sbegin "Making secondary script runnable"
chmod a+x /mnt/sais.sh
sdone
